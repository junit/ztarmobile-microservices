...
public class UserProfileDaoImpl extends AbstractJdbc implements UserProfileDao {
    ...
    public UserProfile findOne(long userProfileId) {
        ...
        String sql = sqlStatements.getProperty("select.balance-notification");
    ...
    public UserProfile findByEmail(UserProfile userProfile) {
        ...
        String sql = sqlStatements.getProperty("select.balance-notification.by.email");
    ...
    public UserProfile save(UserProfile userProfile) {
        ...
        String sql = sqlStatements.getProperty("insert.balance-notification");
