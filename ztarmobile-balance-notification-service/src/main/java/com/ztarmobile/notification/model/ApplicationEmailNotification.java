...
public class ApplicationEmailNotification extends EmailNotification {
    ...
    public ApplicationEmailNotification(boolean success, String enviroment, Throwable reason) {
        ...
        if (success) {
            this.setSubject("[" + enviroment + "] Microservice Balance Notification has started successfully!!!");
            this.reason = null;
        } else {
            this.setSubject("[" + enviroment + "] Ohh no!!, Microservice Balance Notification could not start");
        }
    }
