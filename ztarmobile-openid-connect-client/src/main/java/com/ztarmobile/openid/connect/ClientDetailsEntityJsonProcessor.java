...
import static com.ztarmobile.oauth2.model.RegisteredClientFields.APPLICATION_TYPE;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.CLAIMS_REDIRECT_URIS;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.CLIENT_ID;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.CLIENT_ID_ISSUED_AT;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.CLIENT_NAME;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.CLIENT_SECRET;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.CLIENT_SECRET_EXPIRES_AT;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.CLIENT_URI;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.CODE_CHALLENGE_METHOD;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.CONTACTS;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.DEFAULT_ACR_VALUES;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.DEFAULT_MAX_AGE;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.GRANT_TYPES;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.ID_TOKEN_ENCRYPTED_RESPONSE_ALG;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.ID_TOKEN_ENCRYPTED_RESPONSE_ENC;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.ID_TOKEN_SIGNED_RESPONSE_ALG;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.INITIATE_LOGIN_URI;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.JWKS;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.JWKS_URI;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.LOGO_URI;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.POLICY_URI;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.POST_LOGOUT_REDIRECT_URIS;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.REDIRECT_URIS;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.REGISTRATION_ACCESS_TOKEN;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.REGISTRATION_CLIENT_URI;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.REQUEST_OBJECT_SIGNING_ALG;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.REQUEST_URIS;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.REQUIRE_AUTH_TIME;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.RESPONSE_TYPES;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.SCOPE;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.SCOPE_SEPARATOR;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.SECTOR_IDENTIFIER_URI;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.SOFTWARE_ID;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.SOFTWARE_STATEMENT;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.SOFTWARE_VERSION;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.SUBJECT_TYPE;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.TOKEN_ENDPOINT_AUTH_METHOD;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.TOKEN_ENDPOINT_AUTH_SIGNING_ALG;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.TOS_URI;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.USERINFO_ENCRYPTED_RESPONSE_ALG;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.USERINFO_ENCRYPTED_RESPONSE_ENC;
import static com.ztarmobile.oauth2.model.RegisteredClientFields.USERINFO_SIGNED_RESPONSE_ALG;
import static com.ztarmobile.util.JsonUtils.getAsArray;
import static com.ztarmobile.util.JsonUtils.getAsDate;
import static com.ztarmobile.util.JsonUtils.getAsJweAlgorithm;
import static com.ztarmobile.util.JsonUtils.getAsJweEncryptionMethod;
import static com.ztarmobile.util.JsonUtils.getAsJwsAlgorithm;
import static com.ztarmobile.util.JsonUtils.getAsPkceAlgorithm;
import static com.ztarmobile.util.JsonUtils.getAsString;
import static com.ztarmobile.util.JsonUtils.getAsStringSet;
...
import com.ztarmobile.oauth2.model.ClientDetailsEntity;
...
/**
 * Utility class to handle the parsing and serialization of ClientDetails
 * objects.
 *
 * @author armandorivas
 * @version %I%, %G%
...
public class ClientDetailsEntityJsonProcessor {
     ...
     */
    private static final Logger log = LoggerFactory.getLogger(ClientDetailsEntityJsonProcessor.class);
    ...
    public static ClientDetailsEntity parse(JsonElement jsonEl) {
        if (jsonEl.isJsonObject()) {
            ...
            // these two fields should only be sent in the update request, and
            // MUST match existing values
            ...
            if (jwksEl != null && jwksEl.isJsonObject()) {
                try {
                    JWKSet jwks = JWKSet.parse(jwksEl.toString()); // we have to
                                                                   // pass this
                                                                   // through
                                                                   // Nimbus's
                                                                   // parser as
            ...
            // note that this does not process or validate the software
            // statement, that's handled in other components
        ...
        if (c.getSource() != null) {
            ...
            if (c.getClientSecret() != null) {
                ...
                if (c.getClientSecretExpiresAt() == null) {
                    o.addProperty(CLIENT_SECRET_EXPIRES_AT, 0); // TODO: do we
                                                                // want to let
                                                                // secrets
                                                                // expire?
                } else {
            ...
            o.addProperty(TOKEN_ENDPOINT_AUTH_METHOD,
                    c.getTokenEndpointAuthMethod() != null ? c.getTokenEndpointAuthMethod().getValue() : null);
            ...
            if (c.getJwks() != null) {
                // We have to re-parse it into GSON because Nimbus uses a
                // different parser
            ...
            o.addProperty(REQUEST_OBJECT_SIGNING_ALG,
                    c.getRequestObjectSigningAlg() != null ? c.getRequestObjectSigningAlg().getName() : null);
            o.addProperty(USERINFO_SIGNED_RESPONSE_ALG,
                    c.getUserInfoSignedResponseAlg() != null ? c.getUserInfoSignedResponseAlg().getName() : null);
            o.addProperty(USERINFO_ENCRYPTED_RESPONSE_ALG,
                    c.getUserInfoEncryptedResponseAlg() != null ? c.getUserInfoEncryptedResponseAlg().getName() : null);
            o.addProperty(USERINFO_ENCRYPTED_RESPONSE_ENC,
                    c.getUserInfoEncryptedResponseEnc() != null ? c.getUserInfoEncryptedResponseEnc().getName() : null);
            o.addProperty(ID_TOKEN_SIGNED_RESPONSE_ALG,
                    c.getIdTokenSignedResponseAlg() != null ? c.getIdTokenSignedResponseAlg().getName() : null);
            o.addProperty(ID_TOKEN_ENCRYPTED_RESPONSE_ALG,
                    c.getIdTokenEncryptedResponseAlg() != null ? c.getIdTokenEncryptedResponseAlg().getName() : null);
            o.addProperty(ID_TOKEN_ENCRYPTED_RESPONSE_ENC,
                    c.getIdTokenEncryptedResponseEnc() != null ? c.getIdTokenEncryptedResponseEnc().getName() : null);
            o.addProperty(TOKEN_ENDPOINT_AUTH_SIGNING_ALG,
                    c.getTokenEndpointAuthSigningAlg() != null ? c.getTokenEndpointAuthSigningAlg().getName() : null);
            ...
            o.addProperty(CODE_CHALLENGE_METHOD,
                    c.getCodeChallengeMethod() != null ? c.getCodeChallengeMethod().getName() : null);
