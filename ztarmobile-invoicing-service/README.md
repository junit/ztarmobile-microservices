...
spring init -d=web,thymeleaf,data-rest -g=com.ztarmobile -a=ztarmobile-invoicing-service -v=2.0.0.RELEASE --package-name=com.ztarmobile.invoicing -name=spring-boot-journal -x --force
